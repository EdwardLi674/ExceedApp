                ...
                <div className='login-form'>
                    <form>
                        <div className={`email ${(emailFocus === true ? "emailFocus" : "")}`}>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#525252">
                                    <g>
                            ...
                            <input type="text" placeholder="First Name" onFocus={() => onFocusEmail('email')} onBlur={() => onFocusEmail('email')} className='email-input' />
                        </div>
                        <div className={`email ${(emailFocus === true ? "emailFocus" : "")}`}>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#525252">
                            ...
                            <input type="text" placeholder="Last Name" onFocus={() => onFocusEmail('email')} onBlur={() => onFocusEmail('email')} className='email-input' />
                        </div>
                        <div className={`email ${(emailFocus === true ? "emailFocus" : "")}`}>
                            <span>
                        ...
                        <div className={`password ${passwordFocus === true ? "passwordfocus" : ""}`}>
                            ...
                            <input type="password" placeholder="Password" className='password-input' onFocus={() => onFocusEmail('password')} onBlur={() => onFocusEmail('password')} />
                        </div>
                        <div className='buttonlogin'>
                            <Link to="/welcome"><button className='login-btn'>Sign Up</button></Link>
                        </div>
                    </form>
